export const homeCopy = {
  ...
  whyBody:
    "AI가 바꾸는 일과 커리어, 조직과 사회의 변화는 혼자 읽어서 소화하기 어렵습니다. 서로 다른 자리에서 일하는 사람들이 같은 질문을 들고 모일 때, 비로소 입체적인 이해가 만들어집니다.",
  reasons: [
    {
      title: "질문",
      body: "기술은 빠르게 바뀌지만, 좋은 질문은 저절로 생기지 않습니다. 무엇을 배우고, 지키고, 새롭게 시도할지 함께 묻습니다.",
    },
    {
      title: "현장",
      body: "AI의 변화는 먼 미래가 아니라 이미 우리의 업무와 의사결정에 들어와 있습니다. 각자의 현장에서 겪은 변화를 나눕니다.",
    },
    {
      title: "실험",
      body: "대화는 듣고 끝나지 않습니다. 모임에서 받은 자극을 각자의 일에서 시도해보고, 그 경험을 다시 가져옵니다.",
    },
  ],
  ...
  activities: [
    {
      tag: "Monthly Meetup",
      title: "정기 모임",
      body: "매달 서울에서 열리는 오프라인 모임입니다. 하나의 주제를 전문가 발제와 그룹 토론으로 함께 해석합니다.",
      href: "/meetups",
      cta: "다음 모임 보기 →",
    },
    {
      tag: "One-day Class",
      title: "원데이 클래스",
      body: "AI를 자기 일에 적용하고 싶은 분을 위한 집중형 교육 프로그램입니다. 모임의 대화를 더 깊은 배움으로 잇습니다.",
      href: "/meetups",
      cta: "지난 클래스 살펴보기 →",
    },
    {
      tag: "Team & Corporate",
      title: "소규모·기업 교육",
      body: "팀·조직 단위로 AI 교육이 필요하거나 AX 전환을 고민하는 곳과 맞춤형 교육을 함께 설계해가려 합니다.",
      href: "/contact",
      cta: "문의하기 →",
    },
  ],
...
export const meetupsCopy = {
  ...
  steps: ["네트워킹", "주제 발표", "그룹 토론", "그룹 공유", "전체 Q&A"] as const,
  classTitle: "원데이 클래스",
  classLead:
